...
public class JWTAuthenficationFilter extends UsernamePasswordAuthenticationFilter {
    private AuthenticationManager authenticationManager;

    private JWTHeleper jwtHelper;

    public JWTAuthenficationFilter(AuthenticationManager authenticationManager, JWTHeleper jwtHelper) {
        this.authenticationManager = authenticationManager;
        this.jwtHelper = jwtHelper;
    }

    public JWTAuthenficationFilter( JWTHeleper jwtHelper) {
